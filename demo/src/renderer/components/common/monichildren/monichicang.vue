<template>
  <div class="monichicang">
    ...
    >
      ...
      <el-table-column prop="pro_loss" label="盈亏" width="100" show-overflow-tooltip ></el-table-column>
       <el-table-column prop="this_pro_loss" label="本币盈亏" width="100" show-overflow-tooltip ></el-table-column>
